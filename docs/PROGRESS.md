...
STEP 18 — Add explicit non-scoring search filters.
...
Add bounded fuzzy filename fallback with strict edit-distance and candidate limits so misspellings improve recall without degrading exact relevance.
